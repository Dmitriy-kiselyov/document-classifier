...
module.exports = class Dataset {
    ...
    _filterDictionary(commonDictionary, dictionaries) {
        const commonWordsFilter = DictionaryFilter.commonWordsFilter(dictionaries);
        return DictionaryFilter.filter(commonDictionary, DictionaryFilter.ONCE, commonWordsFilter);
    }
