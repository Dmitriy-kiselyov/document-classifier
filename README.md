...
То есть, убрав больше предлогов можно еще улучшить качество, однако,
цель моей дипломной работы – создание универсального классификатора для
...
Словарь уже приобрел более-менее удобную форму, однако улучшать его есть куда.
Сейчас я перейду на обучение классификатора (это должно значительно увеличить
показатели), а потом будет вторая волна улучшения словаря.
